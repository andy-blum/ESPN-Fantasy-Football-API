...
_defineProperty(BoxscorePlayer, "responseMap", {
  player: {
    key: 'playerPoolEntry',
    BaseObject: _player_player__WEBPACK_IMPORTED_MODULE_2__["default"]
  },
  position: {
    key: 'lineupSlotId',
    manualParse: function manualParse(responseData) {
      return lodash_get__WEBPACK_IMPORTED_MODULE_0___default()(_constants__WEBPACK_IMPORTED_MODULE_4__["slotCategoryIdToPositionMap"], responseData);
    }
  },
  ...
  pointBreakdown: {
    ...
    manualParse: function manualParse(responseData, data, constructorParams) {
      return Object(_player_stats_player_stats__WEBPACK_IMPORTED_MODULE_3__["parsePlayerStats"])({
...
_defineProperty(Boxscore, "responseMap", {
  homeScore: {
    key: 'home',
    manualParse: function manualParse(responseData) {
      return lodash_get__WEBPACK_IMPORTED_MODULE_1___default()(responseData, 'totalPointsLive') || lodash_get__WEBPACK_IMPORTED_MODULE_1___default()(responseData, 'totalPoints');
    }
  },
  ...
  homeRoster: {
    ...
    isArray: true,
    manualParse: function manualParse(responseData, data, constructorParams) {
      return lodash_map__WEBPACK_IMPORTED_MODULE_0___default()(responseData, function (playerData) {
        return _boxscore_player_boxscore_player__WEBPACK_IMPORTED_MODULE_3__["default"].buildFromServer(playerData, constructorParams);
      });
    }
  },
  awayScore: {
...
/*!**************************!*\
  !*** ./src/constants.js ***!
  \**************************/
/*! exports provided: nflTeamIdToNFLTeam, nflTeamIdToNFLTeamAbbreviation, slotCategoryIdToPositionMap */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "nflTeamIdToNFLTeam", function() { return nflTeamIdToNFLTeam; });
...
_defineProperty(FreeAgentPlayer, "responseMap", {
  player: {
    key: 'player',
    manualParse: function manualParse(responseData, data, constructorParams) {
      return _player_player__WEBPACK_IMPORTED_MODULE_1__["default"].buildFromServer(data, constructorParams);
    }
  },
  rawStats: {
    key: 'player',
    manualParse: function manualParse(responseData, data, constructorParams) {
      return Object(_player_stats_player_stats__WEBPACK_IMPORTED_MODULE_2__["parsePlayerStats"])({
        responseData: data,
        constructorParams: constructorParams,
        usesPoints: false,
...
/*!**********************!*\
  !*** ./src/index.js ***!
  \**********************/
/*! exports provided: Boxscore, BoxscorePlayer, Client, FreeAgentPlayer, Player, PlayerStats, Team */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Boxscore", function() { return _boxscore_boxscore__WEBPACK_IMPORTED_MODULE_0__["default"]; });
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "BoxscorePlayer", function() { return _boxscore_player_boxscore_player__WEBPACK_IMPORTED_MODULE_1__["default"]; });

/* harmony import */ var _client_client__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./client/client */ "./src/client/client.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Client", function() { return _client_client__WEBPACK_IMPORTED_MODULE_2__["default"]; });

/* harmony import */ var _free_agent_player_free_agent_player__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./free-agent-player/free-agent-player */ "./src/free-agent-player/free-agent-player.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "FreeAgentPlayer", function() { return _free_agent_player_free_agent_player__WEBPACK_IMPORTED_MODULE_3__["default"]; });

/* harmony import */ var _player_player__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./player/player */ "./src/player/player.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Player", function() { return _player_player__WEBPACK_IMPORTED_MODULE_4__["default"]; });

/* harmony import */ var _player_stats_player_stats__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./player-stats/player-stats */ "./src/player-stats/player-stats.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "PlayerStats", function() { return _player_stats_player_stats__WEBPACK_IMPORTED_MODULE_5__["default"]; });

/* harmony import */ var _team_team__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./team/team */ "./src/team/team.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Team", function() { return _team_team__WEBPACK_IMPORTED_MODULE_6__["default"]; });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var lodash_toSafeInteger__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lodash/toSafeInteger */ "./node_modules/lodash/toSafeInteger.js");
/* harmony import */ var lodash_toSafeInteger__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(lodash_toSafeInteger__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var lodash_get__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! lodash/get */ "./node_modules/lodash/get.js");
/* harmony import */ var lodash_get__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(lodash_get__WEBPACK_IMPORTED_MODULE_1__);
...
_defineProperty(League, "responseMap", {
  ...
  rosterSettings: {
    ...
    manualParse: function manualParse(responseData) {
      return {
        lineupPositionCount: lodash_mapKeys__WEBPACK_IMPORTED_MODULE_2___default()(responseData.lineupSlotCounts, function (count, position) {
          return lodash_get__WEBPACK_IMPORTED_MODULE_1___default()(_constants_js__WEBPACK_IMPORTED_MODULE_4__["slotCategoryIdToPositionMap"], position);
        }),
        positionLimits: lodash_mapKeys__WEBPACK_IMPORTED_MODULE_2___default()(responseData.positionLimits, function (count, position) {
          return lodash_get__WEBPACK_IMPORTED_MODULE_1___default()(_constants_js__WEBPACK_IMPORTED_MODULE_4__["slotCategoryIdToPositionMap"], position);
        }),
  ...
  _createClass(NFLGame, null, [{
    ...
    value: function _buildTeamAttribute(teamResponseData) {
      return {
        ...
        team: lodash_get__WEBPACK_IMPORTED_MODULE_2___default()(_constants_js__WEBPACK_IMPORTED_MODULE_4__["nflTeamIdToNFLTeam"], teamResponseData.id),
        teamAbbrev: lodash_get__WEBPACK_IMPORTED_MODULE_2___default()(_constants_js__WEBPACK_IMPORTED_MODULE_4__["nflTeamIdToNFLTeamAbbreviation"], teamResponseData.id),
        record: teamResponseData.record,
        score: lodash_toSafeInteger__WEBPACK_IMPORTED_MODULE_0___default()(teamResponseData.score)
      };
    }
  }]);
...
_defineProperty(NFLGame, "responseMap", {
  ...
  gameStatus: {
    key: 'status',
    manualParse: function manualParse(responseData) {
      return lodash_get__WEBPACK_IMPORTED_MODULE_2___default()(NFLGame.GAME_STATUSES, responseData);
    }
  },
  homeTeam: {
    key: 'competitors',
    manualParse: function manualParse(responseData) {
      return NFLGame._buildTeamAttribute(lodash_find__WEBPACK_IMPORTED_MODULE_1___default()(responseData, {
        homeAway: 'home'
      }));
    }
  },
...
/*!******************************************!*\
  !*** ./src/player-stats/player-stats.js ***!
  \******************************************/
/*! exports provided: parsePlayerStats, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "parsePlayerStats", function() { return parsePlayerStats; });
/* harmony import */ var lodash_get__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! lodash/get */ "./node_modules/lodash/get.js");
/* harmony import */ var lodash_get__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(lodash_get__WEBPACK_IMPORTED_MODULE_0__);
...
_defineProperty(Player, "responseMap", {
  ...
  jerseyNumber: {
    key: 'jersey',
    manualParse: function manualParse(responseData) {
      return lodash_toNumber__WEBPACK_IMPORTED_MODULE_2___default()(responseData);
    }
  },
  proTeam: {
    key: 'proTeamId',
    manualParse: function manualParse(responseData) {
      return lodash_get__WEBPACK_IMPORTED_MODULE_1___default()(_constants_js__WEBPACK_IMPORTED_MODULE_4__["nflTeamIdToNFLTeam"], responseData);
    }
  },
  proTeamAbbreviation: {
    key: 'proTeamId',
    manualParse: function manualParse(responseData) {
      return lodash_get__WEBPACK_IMPORTED_MODULE_1___default()(_constants_js__WEBPACK_IMPORTED_MODULE_4__["nflTeamIdToNFLTeamAbbreviation"], responseData);
    }
  },
  defaultPosition: {
    key: 'defaultPositionId',
    manualParse: function manualParse(responseData) {
      return lodash_get__WEBPACK_IMPORTED_MODULE_1___default()(_constants_js__WEBPACK_IMPORTED_MODULE_4__["slotCategoryIdToPositionMap"], responseData);
    }
  },
  eligiblePositions: {
    key: 'eligibleSlots',
    manualParse: function manualParse(responseData) {
      return lodash_map__WEBPACK_IMPORTED_MODULE_0___default()(responseData, function (posId) {
        return lodash_get__WEBPACK_IMPORTED_MODULE_1___default()(_constants_js__WEBPACK_IMPORTED_MODULE_4__["slotCategoryIdToPositionMap"], posId);
      });
    }
  },
...
_defineProperty(Team, "responseMap", {
  ...
  roster: {
    ...
    isArray: true,
    manualParse: function manualParse(responseData, data, constructorParams) {
      return lodash_map__WEBPACK_IMPORTED_MODULE_1___default()(responseData, function (playerData) {
        return _player_player__WEBPACK_IMPORTED_MODULE_4__["default"].buildFromServer(playerData.playerPoolEntry, constructorParams);
      });
    }
  },
  ...
  winningPercentage: {
    ...
    manualParse: function manualParse(responseData) {
      return lodash_round__WEBPACK_IMPORTED_MODULE_0___default()(responseData * 100, 2);
    }
  },
